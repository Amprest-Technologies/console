<template>
  <div id="pay-airtel-money" class="accordion container bg-white rounded shadow">
    <button
      class="accordion-intro flex items-center w-full p-2 lg:p-3 focus:outline-none"
      @click.prevent="toggleAccordion"
    >
      <img src="/img/payments/airtel-money.png" class="mr-4 w-20" />
      <h2 class="font-semibold avenir-font text-lg">Pay with Airtel Money</h2>
    ...
    <div class="accordion-body hidden transition-all duration-500 ease-in-out">
      <div class="bg-wheat mb-4 px-5 py-4">
        <ol class="list-decimal px-5">
          <li class="mb-3 work-sans-font">Go to your Airtel Money Menu.</li>
          <li class="mb-3 work-sans-font">Go to Lipa na Airtel Money.</li>
...
export default {
  ...
  methods: {
    toggleAccordion: function () {
      // Get the elements.
      const trigger = document.querySelector('#pay-airtel-money>.accordion-intro');
